...
| 실행 전 | 실행 후 |
|---|---|
| ![업로드 완료, 분석 시작 전](docs/screenshots/process_01_upload.png) | ![분석 시작 후 Phase 0 완료](docs/screenshots/process_02_phase0_done.png) |
...
| 실행 전 (재확인 대기 12건) | 실행 후 (Phase 0.5 완료) |
|---|---|
| ![Phase 0.5 재확인 대기, 버튼 클릭 직전](docs/screenshots/process_03_phase05_before.png) | ![Phase 0.5 완료 후 대시보드](docs/screenshots/process_04_phase05_done.png) |
...
| 실행 전 (32건 대기) | 실행 후 (분류·추천 완료) |
|---|---|
| ![Phase 1 실행 전, 버튼 클릭 직전](docs/screenshots/process_05_phase1_before.png) | ![Phase 1 실행 후 4-type 분포](docs/screenshots/process_06_phase1_done.png) |
